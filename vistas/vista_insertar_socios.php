...
<?php
    ...
    <main>
        <section id="admin" class="container d-flex justify-content-evenly align-items-center text-white my-5 vh-100">
            <form action="../controladores/controlador_insertar_socios.php" method="post" enctype="multipart/form-data"  class="row g-3">
                ...
                <div class="col-12 mt-3">
                    <button class="btn btn-danger" type="submit" name="enviar">Registrar Socio</button>
                </div>
            </form>
        </section>
    </main>
